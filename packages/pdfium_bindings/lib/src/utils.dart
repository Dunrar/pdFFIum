...
Pointer<Utf8> stringToNativeUtf8(String str, {Allocator allocator = calloc}) {
...
Pointer<Void> stringToNativeVoid(String str, {Allocator allocator = calloc}) {
  return stringToNativeUtf8(str, allocator: allocator).cast();
}
...
Pointer<Void> intToNativeVoid(int number, {Allocator allocator = calloc}) {
  final ptr = allocator<Int32>(sizeOf<Int32>());
  ptr.value = number;
  return ptr.cast();
}
